...
if($lastInsertId)
{
$msg="Staff info added successfully";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <title>SRMS Admin| Staff Registration< </title>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Staff ID</label>
<div class="col-sm-10">
<input type="text" name="staffid" class="form-control" id="rollid" required="required" autocomplete="off">
</div>
</div>
