                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-12">
                                <h2 class="title" align="center">STUDENT RECORD MANAGEMENT SYSTEM</h2>
                            </div>
                        </div>
                        <!-- /.row -->
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <h3 align="center">Student Semester Result Details</h3>
                                                <hr />
                                                <?php
                                                // code Student Data
                                                $rollid = $_POST['rollid'];
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center"><?php if ($result->fe + $result->ca >= 70) {
                                                                                                        $gpaCnt = $gpaCnt + 5;
                                                                                                        echo "A";
                                                                                                    }
                                                                                                    if ($result->fe + $result->ca >= 60 && $result->fe + $result->ca < 70) {
                                                                                                        $gpaCnt = $gpaCnt + 4;
                                                                                                        echo "B+";
                                                                                                    }
                                                                                                    if ($result->fe + $result->ca >= 50 && $result->fe + $result->ca < 60) {
                                                                                                        $gpaCnt = $gpaCnt + 3.5;
                                                                                                        echo "B";
                                                                                                    }
                                                                                                    if ($result->fe + $result->ca >= 40 && $result->fe + $result->ca < 50) {
                                                                                                        $gpaCnt = $gpaCnt + 2;
                                                                                                        echo "C";
                                                                                                    }
                                                                                                    if ($result->fe + $result->ca  < 40) {
                                                                                                        $gpaCnt = $gpaCnt + 1;
                                                                                                        echo "F";
                                                                                                    } ?></td>
                                                                </tr>
